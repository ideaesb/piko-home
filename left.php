<div id = "leftColumn"> <!--code taken from NOAA website for left menu-->
 <div id="leftNav"> <!--code taken from NOAA website for left menu-->
  ...
  <ul id="leftNavElements">
   ...
   <li id="leftNavOrganizations"><a href="/daps"><strong>Data and Products</strong></a></li>
   <li id="leftNavOrganizations"><a href="/pawz"><strong>Projects and Activities</strong></a></li>
   <li id="leftNavOrganizations"><a href="/asmts">Assessments</a></li>
   <li id="leftNavOrganizations"><a href="/orgs">Partners &amp; Programs</a></li>
   <li id="leftNavOrganizations"><a href="contact.php">Contact Us</a></li>
  </ul>
